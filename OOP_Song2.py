...
# ===============================================================
# Updating the OOP_song - Using getter function
# ===============================================================

# We will make our program work without renaming the class title attribute (using getter function)
# And show how code with "title" can work even if the code expect the attribute to be called "name"
...
def create_checkfile(artist_list):
    ...
    with open("checkfile3.txt", 'w') as checkfile:  # we are creating new file named checkfile, hence method r for write
